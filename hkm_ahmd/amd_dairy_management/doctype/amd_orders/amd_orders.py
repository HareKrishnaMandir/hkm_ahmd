...
#         # Prevent duplicate order for same subscription/date/shift
#         if order_already_exists(sub_doc, delivery_date, target_shift):
#             continue

#         # Subscription day logic
...
#     Only these orders are considered:
